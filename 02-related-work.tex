...
The methodology for crash and concurrency reasoning used in Flashix is quite
different from the approach of this thesis. Refinement in Flashix is defined in terms of ``components,'' which are like a class in an object-oriented language. The proof is split into two parts,
...
implementation. This proof is carried out using a mover-style argument,
...
that shows crash safety.

The Perennial program logic is based on a specification of an individual
procedure, rather than for a whole component. This specification covers crash and
