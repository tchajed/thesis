...
write-ahead logging system that was verified (with a pen-and-paper proof) in
...
AtomFS does concurrency reasoning~\cite{zou:atomfs}.

Isotope has a similar design but no verification~\cite{shin:isotope}.
