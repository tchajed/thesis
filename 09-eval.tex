...
running on tmpfs:
bench         dnfs       dnfs-seq-txn  dnfs-seq-wal  linux       linux-ordered
smallfile-1   1899.7582  1908.0521     1816.1219     2116.4551   2024.4887
smallfile-25  7811.338   3245.1898     4191.8783     13742.4956  13641.676
largefile     209.69     240.52        190.35        242.18      421.08
app           0.42735    0.438596      0.423729      0.436681    0.446429
\end{verbatim}
...
\cref{fig:bench-configs} \tej{Fix setup for this benchmark to average over
several runs and report as a bar graph with normalized throughput}
The variants of DaisyNFS make changes to GoTxn to reduce concurrency: the
\cc{dnfs-seq-wal} configuration adds locks to the write-ahead log so that the
...
accessing GoTxn but no disk parallelism. \cc{dnfs-seq-txn} leaves the
...
hand \cc{dnfs-seq-txn} actually performs \emph{better} on the largefile
...
\cc{data=ordered} mode. This only makes a difference for asynchronous NFS
...
largefile benchmark \cc{linux-ordered} gets 80\% higher throughput. An
