...
with an in-memory disk. This is due to less efficient I/O;
looking at the kernel's I/O statistics, both file systems have similar total
disk bandwidth (130 MB/s for Linux and 120 MB/s for DaisyNFS), even though
DaisyNFS is only completing 60\% as many iterations of smallfile per second.
DaisyNFS spends most of its time waiting on disk I/O in this benchmark.
