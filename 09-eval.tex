...
\tej{revise this section in light of new results and better understanding}
...
primarily due to lock contention. \tej{not quite true, Linux is bottlenecked by something else}
