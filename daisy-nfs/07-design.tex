...
specification is given using pre- and post-conditions. \Cref{sec:daisy:proof-dafny},
...
The final \cc{daisy-nfsd} binary also implements the NFS wire protocol in
