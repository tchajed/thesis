...
\tej{merge any useful changes from the DaisyNFS paper}

\newcommand{\txnmapsto}{\mapsto_{\cc{txn}}}
\newcommand{\thdmapsto}{\Rightarrow}

Recall that \cref{thm:gotxn-program-refinement} establishes a program refinement
for programs written the Txn layer and Disk layer. That is, given a program
...
specification's behaviors (with high-level transaction-system operations).
