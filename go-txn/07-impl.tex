...
\tej{need to update the Perennial lines-of-code scripts to cover GoTxn as well}
...
largely in establishing its atomic transitions, while half of the top-level GoTxn
proof is proving the lifting specification described in
