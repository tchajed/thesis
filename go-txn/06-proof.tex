...
\tej{make some tweaks to refer back to Perennial
  chapter, which explains this more formally}
...
\scc{wal} layer.  This implementation is split into two parts. The first checks
