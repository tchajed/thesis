...
per-operation specifications. The Coq development uses Perennial's soundness
theorem to prove that these refinement triples imply refinement. This involves using
