...
transaction also has ownership over $\bigast_{(a,o) \in J} a \mapstoLftd o$
(which need to be returned on crash) and $\bigast_{(a,o') \in J' a \mapstoOp o'}$.
...
the transactional disk and show that the transaction \cc{f} was correctly simulated.
