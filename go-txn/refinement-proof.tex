...
\tej{We should be able to say more precisely now how the Commit spec is enough.
This will also pull in some explanation of how crashes interact with
refinement and how we are allowed to do some exchanging, not entirely sure how
that works.}
