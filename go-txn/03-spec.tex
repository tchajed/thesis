...
\emph{refinement}, which is a relationship between a code and a specification.
Abstractly, refinement from a code program to
a specification says that the behaviors of the code are a subset of the
...
will use to connect a program written at the transaction layer to its
implementation at the disk layer.
...
\Cref{thm:gotxn-program-refinement} is stated in Coq and has a fully mechanized
proof in Perennial.
