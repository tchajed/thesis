...
concurrent operations manipulate disjoint sets of addresses. In the case of GoTxn, that caller is
the two-phase locking code, whose proof is described in \cref{sec:txn:refinement}.

\tej{add the GoJournal API here}
...
to lifting and explained below. \tej{maybe add a small figure showing the
lifecycle, similar to GoJournal talk}
