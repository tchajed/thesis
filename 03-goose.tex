...
lemma, which is applied automatically with a tactic \cc{wp\_pures}.
...
\cc{defer} statically; Go's general \cc{defer} is much more
...
load (in C, this would be written \cc{x-\textgreater{}f}). The model
...
stdpp; for simplicity we use \cc{gmap\ uint64\ val} and limit map
