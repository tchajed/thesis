...
\begin{figure}
  ...
  \begin{array}{llcl}
    ...
    \textdom{Exp}& e &::= & x \ALT v \ALT e \app e %
                            ...
                            \ALT \goosekw{rec} \, f(x) = e \\
    &&\ALT & \goosekw{if} \app e \app
             \goosekw{then} \app e \app \goosekw{else} \app e \\
    ...
    &&\ALT & \goosekw{AllocN} \app e \app e
             \ALT \goosekw{CmpXchg} \app e \app e \app e %
             \ALT \goosekw{Load} \app e \\
    &&\ALT & \goosekw{PrepareWrite} \app e %
             \ALT \goosekw{FinishStore} \app e \app e %
             \ALT \goosekw{StartRead} \app e %
             \ALT \goosekw{FinishRead} \app e %
  \end{array}
  \end{mathpar}
...
\begin{figure}
  ...
  \begin{array}{llcl}
    \textdom{ECtx}& E &::= & \square \ALT E \app v \ALT e \app E  %
                  ...
                  &&\ALT & \goosekw{if} \app E \app \goosekw{then} \app e \app
                           \goosekw{else} \app e \\
...
\tej{finish describing GooseLang semantics}
