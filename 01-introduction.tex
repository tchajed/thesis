Formal verification is a promising approach for improving reliability, in which
...
\section{Broader value of this thesis}

\tej{lift the most important points from conclusion to intro}
