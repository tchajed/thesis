...
system that runs on flash devices. This thesis develops the Perennial program
logic, which has the benefit of supporting general concurrency reasoning
principles, whereas Flashix has its own methodology based primarily around
locks. This thesis also isolates crash and concurrency reasoning using
transactions, while Flashix reasons about crashes and concurrency throughout the
entire stack.
