...
another verified, concurrent file system, Flashix~\todo{citation}. The use case for Flashix is
...
Flashix uses an ordered cache that is carefully designed to work with its
particular file-system design.
...
correctly implementing a file system (see Featherstich~\todo{citation},
BetrFS~\todo{citation}, or btrfs, for example), they
