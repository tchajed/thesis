...
\tej{find a real file-system bug example to explain (or at least point to)}
...
\Cref{fig:overview} depicts how the artifacts of this thesis combine. \tej{refer
to this figure earlier in this section} GoTxn is
