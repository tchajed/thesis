...
context. \tej{I could change this, but I like the Goose chapter being truly
self-contained}
...
\cref{sec:perennial} is (planned to be) a brief overview of Perennial, to
give a sense for how the GoTxn proofs work. The GoTxn chapter, \cref{sec:txn}
...
\cref{sec:daisy-nfs} describes the way DaisyNFS connects Dafny to GoTxn, the
