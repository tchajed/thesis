...
logic, a general framework for reasoning about crash safety in concurrent
software (Flashix has a different methodology for its proofs). This thesis also
isolates crash and concurrency reasoning using transactions, while Flashix
reasons about crashes and concurrency throughout the entire stack.
