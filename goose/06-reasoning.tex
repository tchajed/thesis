...
can observe buffered writes at different times. Go's own memory model specifies
...
Similarly \cc{s[i] = x} stores to the same location. Goose
translates Go's \cc{len(s)} directly to $\len(s)$. Go also supports
