...
reasoning, we don't need to split up $R$ to prove these two entailments. Also
observe that this rule reduces crash reasoning to non-crash reasoning. There are two
...
system's \emph{recovery procedure}. To allow the user to reason about the recovery process, Perennial
