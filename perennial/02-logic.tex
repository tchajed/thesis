...
that $e$ runs ``safely'' in the sense of encountering an irreducible expression;
the semantics uses stuckness to indicate an expression that has hit an error. This immediately
