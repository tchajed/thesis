...
state will satisfy $Q$. Note that
$P \proves \wpre{e}{Q}$ is equivalent to $\hoare{P}{e}{Q}$, which can help give
some intuition around weakest preconditions. An excellent
