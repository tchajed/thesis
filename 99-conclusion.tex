...
is. This section gives several broader points as to what the value of verification is.
...
This work helps give an upper bound on the cost, but further research would
...
\paragraph{Mechanized proofs are good for change.} Informal
...
experienc with adapting a proof when adding indirect blocks: at some point a
