...
\txn consists of multiple layers, as described in \cref{s:system:impl}.  This
...
\begin{figure}[ht]
\input{go-journal/code/walcrashspec}
\vspace{-\baselineskip}
...
\begin{figure}
  \input{go-journal/fig/appendhocap}
...
\begin{figure}[ht]
\centering
\input{go-journal/fig/sub-block-concurrency}
\vspace{-\baselineskip}
...
%
% \begin{figure}[ht]
% \input{go-journal/code/walreads}
