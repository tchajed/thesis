...
refinement condition (1) diagrammatically. \tej{consider rearranging this, maybe
move simulation transfer to DaisyNFS chapter, so we immediately connect to Dafny
there?}
